...
async fn completions_endpoint_accepts_empty_stop_array() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","prompt":"hello","max_tokens":1,"stop":[]}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn completions_endpoint_accepts_disabled_echo() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","prompt":"hello","max_tokens":1,"echo":false}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn completions_endpoint_accepts_empty_logit_bias() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","prompt":"hello","max_tokens":1,"logit_bias":{}}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn completions_endpoint_accepts_user_identifier() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","prompt":"hello","max_tokens":1,"user":"local-user-1"}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_empty_stop_array() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"stop":[]}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_disabled_logprobs_and_store(
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"logprobs":false,"store":false}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_empty_logit_bias() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"logit_bias":{}}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_text_response_format() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"response_format":{"type":"text"}}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_text_only_modalities() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"modalities":["text"]}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_null_optional_openai_options(
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"audio":null,"moderation":null,"prediction":null,"verbosity":null,"web_search_options":null}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_explicit_no_tool_options() -> Result<(), Box<dyn std::error::Error>>
{
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"tools":[],"tool_choice":"none","parallel_tool_calls":false}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_parallel_tool_calls_without_tools(
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"tools":[],"parallel_tool_calls":true}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_explicit_no_function_options(
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"functions":[],"function_call":"none"}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_user_identifier() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"user":"local-user-1"}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_seed() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"seed":42}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_metadata_object() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"metadata":{"trace_id":"local-123","tenant":"dev"}}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_prompt_cache_key() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"prompt_cache_key":"tenant-a:prompt-1"}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
...
async fn chat_endpoint_accepts_no_reasoning_effort() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = Request::builder()
        ...
        .header("content-type", "application/json")
        .body(Body::from(
            r#"{"model":"fixture-model","messages":[{"role":"user","content":"hello"}],"max_completion_tokens":1,"reasoning_effort":"none"}"#,
        ))?;
    let response = app.oneshot(request).await?;
    remove_fixture_model(&model_path)?;
