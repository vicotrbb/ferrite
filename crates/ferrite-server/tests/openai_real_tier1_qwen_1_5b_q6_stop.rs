...
async fn live_http_server_applies_stop_sequences_with_qwen_1_5b_q6_model(
    ...
    .await?;
    assert_stop_completion_response(&completion_response, qwen_1_5b_q6_stop_expectation())?;
...
fn qwen_1_5b_q6_stop_expectation() -> StopSequenceExpectation {
