...
async fn live_http_server_serves_qwen_1_5b_q8_wait_queue_in_start_order()
-> Result<(), Box<dyn std::error::Error>> {
    ...
    assert_qwen_1_5b_q8_completion_response(&queued_one_response)?;
    assert_qwen_1_5b_q8_completion_response(&queued_two_response)?;
    Ok(())
}
