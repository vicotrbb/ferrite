...
- `documentation/engineering/tier0-gate-status.md` records the current Tier 0
  evidence matrix and remaining caveat.
- `documentation/dev-notes/2026-06-27-tier0-smollm2-360m-probe.md` records the
  SmolLM2-360M default, CPU-only, and CPU no-repack reference split.
- `documentation/dev-notes/2026-06-27-cli-top-logits-diagnostic.md` records the
  Ferrite top-logits diagnostic at the first 360M divergence point.
- `documentation/dev-notes/2026-06-27-cli-generated-token-gate.md` records the
  generated-token CLI gate used to turn reference token IDs into executable
  checks.
- `cargo fmt --all -- --check`
