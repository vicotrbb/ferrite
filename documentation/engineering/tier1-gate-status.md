...
from prior completed streaming responses. Those runs record token-limit status,
fresh disconnect reconnect generation, usage accounting, timing, RSS samples,
and `long_chat_summary_run_complete=true`.
...
| OpenAI-compatible generated-context long-chat proof | Partially proven locally for Qwen2.5-0.5B Q4_K_M at 256, 512, and 1024 completion tokens. These current-harness reruns prove the first turn used seed assistant context, follow-up turns used generated assistant context, token-limit status was present, reconnect after disconnect started a fresh generated stream, and each integrated run completed. This is one local model only; larger Tier 1 artifacts, x86_64 generated-context reruns, EOS-specific long-chat behavior, and steady-state serving remain unproven | `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-1024.md`; the 256-token release run on commit `3591b844224a606a52f58d1972e58fb5a143e1cb`, 512-token release run on commit `cddbfa5a2d42d1749dc2e8e1ba5d16df09effb67`, and 1024-token release run on commit `3eba26690fe6cf73819274d9abc748a3fe5232fb` all wrote exit code `0`; all three runs reported turn 1 as `long_chat_result_assistant_context_source=seed`, turns 2-4 as `generated`, and summaries with `long_chat_summary_all_follow_up_turns_use_generated_context=true`, `long_chat_summary_all_token_limit_status_present=true`, `long_chat_summary_disconnect_probe_reconnect_started_new_generation=true`, and `long_chat_summary_run_complete=true` |
