...
server memory sample. Qwen2.5-1.5B Q8_0 now has the same bounded local
32-token HTTP chat-completion server memory shape for the larger Qwen2.5 Tier
1 artifact. Broader chat memory posture remains unproven.
