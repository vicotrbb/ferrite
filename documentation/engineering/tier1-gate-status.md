...
The long-chat gate is still not a release-complete readiness claim: EOS-specific
evidence, x86_64 behavior, longer steady-state behavior, and broader combined
full-length reconnect/error runs remain unproven.
