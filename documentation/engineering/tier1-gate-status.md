...
As partial evidence toward that gate, all four required Tier 1 HTTP model
artifacts now have integrated stop-summary runs through the long-chat harness:
Qwen2.5-0.5B Q4_K_M, Qwen2.5-1.5B Q8_0, Qwen2.5-1.5B Q6_K, and
SmolLM2-1.7B Q4_K_M. Those runs prove stop-finished streaming chat scenarios,
...
They remain stop-focused short runs, not the full 256/512/1024-token long-chat
gate and not EOS-specific evidence.
