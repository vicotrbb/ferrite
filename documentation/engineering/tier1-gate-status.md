...
| Qwen2 Tier 1 model coverage | Loads and executes; correctness not proven | `documentation/dev-notes/2026-06-27-tier1-qwen2-0-5b-probe.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-config-parser.md`; `documentation/dev-notes/2026-06-27-scalar-qkv-projection-bias.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-loader-dispatch.md`; Qwen2.5-0.5B-Instruct Q4_K_M now loads and generates from token-id and text prompts, but deterministic `llama.cpp` reference parity failed: Ferrite generated `[2857,25,16]` where the reference continuation tokenized to `[198,9707,11]` |
...
- Continue first-class Qwen2 architecture handling before claiming coverage for
  the Qwen2.5 Tier 1 models. Config parsing, Q/K/V projection bias support, and
  runtime loader dispatch exist, but Qwen2.5-0.5B Q4_K_M deterministic
  reference-token parity currently fails.
