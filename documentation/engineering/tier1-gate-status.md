...
`llama.cpp` deterministic reference profiles for the same six prompts, and
their first five Q8_0/Q6_K prompt profiles now also match on x86_64 AVX2.
SmolLM2-1.7B, Qwen2.5-0.5B, and Qwen2.5-1.5B Q4_K_M also matched their first
three fixed prompts plus the fifth fixed prompt on x86_64 AVX2. The
Qwen2.5-1.5B proof exercises the Tier 1 head_dim=128 model.
...
| AVX2 correctness | Focused runtime backend tests passed for F32, Q8_0, Q5_0, Q6_K, and Q4_K on an x86_64 AVX2 homelab pod; fixed SmolLM2-1.7B, Qwen2.5-0.5B, and Qwen2.5-1.5B Q4_K_M model-output profiles matched their first three plus fifth fixed prompts on x86_64 AVX2; Qwen2.5-0.5B Q8_0 and Q6_K also matched the first five fixed Qwen2 prompts on x86_64 AVX2; broader throughput still unproven | `documentation/dev-notes/2026-06-27-tier1-x86-64-avx2-f32-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-x86-64-avx2-q8-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-x86-64-avx2-q5-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-x86-64-avx2-q6-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-x86-64-avx2-q4-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-q4k-row-parallel-simd.md`; `documentation/dev-notes/2026-06-27-tier1-q6k-row-parallel-simd.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-runtime-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-prompt-expansion.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-1-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-smollm2-1-7b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-q8-q6-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-fifth-prompt-reference.md`; `cargo check -p ferrite-inference --target x86_64-unknown-linux-gnu --tests`; `cargo test -p ferrite-inference avx2 -- --nocapture`; `cargo test -p ferrite-inference simd_matvec_preserves_parallel_row_order -- --nocapture`; `cargo test -p ferrite-inference q8_0_argmax_mul_vec_matches_full_matvec_argmax -- --nocapture`; x86_64 fixed SmolLM2 prompts matched `[18,198,3725,198,198,788]`, `[7042,30,2]`, `[28,281,253,1165,6560,32047]`, and fifth-prompt `[597,325,804,288,6524,260]`; x86_64 fixed Qwen2.5-0.5B Q4_K_M prompts matched `[198,9707,11]`, `[12095,13,1084]`, `[11,1052,572]`, and fifth-prompt `[387,1483,311,7023,279,28636]`; x86_64 fixed Qwen2.5-1.5B prompts matched `[198,9707,11]`, `[12095,13,576]`, `[11,1052,572]`, and fifth-prompt `[387,1483,311,7023,279,28636]`; x86_64 Qwen2.5-0.5B Q8_0 and Q6_K matched `[198,9707,11,4337,0,2585]`, `[12095,13,1084,374,279,7772]`, `[11,1052,572,264,3908,883]`, `[429,374,6188,311,387,6092]`, and `[387,1483,311,7023,279,28636]` |
...
| Real 0.5B-1.7B model output | Partially proven for six fixed 1.7B Llama-family prompts and six fixed Qwen2 prompts on local aarch64; Qwen2.5-0.5B also has Q8_0 and Q6_K full-model output parity over those six prompts locally and the first five on x86_64 AVX2; Q4_K_M artifacts have the first three plus fifth prompt proven on x86_64 AVX2 | `documentation/dev-notes/2026-06-27-tier1-smollm2-1-7b-reference-probe.md`; `documentation/dev-notes/2026-06-28-tier1-smollm2-second-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-third-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-fourth-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-fifth-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-sixth-prompt-reference.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-rope-layout.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-1-5b-reference-probe.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-second-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-0-5b-q8-0-reference.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-0-5b-q6-k-reference.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-prompt-expansion.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-1-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-smollm2-1-7b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-q8-q6-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-fifth-prompt-reference.md`; Ferrite matched local `llama.cpp` token IDs `[18, 198, 3725, 198, 198, 788]`, `[7042,30,2]`, `[28,281,253,1165,6560,32047]`, and `[338,2433,253,1837,3500,1743]` for SmolLM2-1.7B-Instruct Q4_K_M; both Qwen2.5 Q4_K_M models matched `[198,9707,11]` for `hello world`, their documented France continuations, `[11,1052,572]` for `Once upon a time`, and `[429,374,6188]` for `Rust is a systems programming language`; Qwen2.5-0.5B-Instruct Q8_0 and Q6_K matched `[198,9707,11,4337,0,2585]`, `[12095,13,1084,374,279,7772]`, `[11,1052,572,264,3908,883]`, and `[429,374,6188,311,387,6092]` locally and on x86_64 AVX2; the fifth prompt matched `[597,325,804,288,6524,260]` for SmolLM2-1.7B Q4_K_M and `[387,1483,311,7023,279,28636]` for the Qwen2 local artifacts on both local aarch64 and x86_64 AVX2; the sixth local prompt matched `[216,34,12382,282,7367,30]` for SmolLM2-1.7B Q4_K_M, `[220,17,25374,315,19828,323]` for Qwen2.5-1.5B Q4_K_M, and `[220,18,25374,315,19828,13]` for the Qwen2.5-0.5B local artifacts |
| Qwen2 Tier 1 model coverage | Partially proven for Qwen2.5-0.5B and 1.5B Q4_K_M over six fixed prompts locally, plus Qwen2.5-0.5B Q8_0 and Q6_K over the same six prompts locally and the first five on x86_64 AVX2 | `documentation/dev-notes/2026-06-27-tier1-qwen2-0-5b-probe.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-config-parser.md`; `documentation/dev-notes/2026-06-27-scalar-qkv-projection-bias.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-loader-dispatch.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-rope-layout.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-1-5b-reference-probe.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-second-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-third-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-fourth-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-fifth-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-sixth-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-0-5b-q8-0-reference.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-0-5b-q6-k-reference.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-q8-q6-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-fifth-prompt-reference.md`; Qwen2.5-0.5B-Instruct and Qwen2.5-1.5B-Instruct Q4_K_M both load, use split-half RoPE, and match deterministic local `llama.cpp` reference continuations for the six fixed prompts; Qwen2.5-0.5B-Instruct Q8_0 and Q6_K also load and match those six prompt profiles locally and their first five on x86_64 AVX2 |
...
- Expand Qwen2 coverage beyond the six fixed Q4_K_M local prompt profiles and
  the Qwen2.5-0.5B Q8_0/Q6_K local prompt profiles. x86_64 Q4_K_M
  fourth-prompt coverage, x86_64 sixth-prompt coverage, broader prompt
  coverage, 1.5B additional quantizations, and broader throughput remain
  unproven.
