...
matvec reference-comparison gate, and an aarch64 NEON F32 matvec path checked
against the scalar oracle. It does not yet prove AVX2 correctness, quantized
SIMD kernels, real 0.5B-1.7B model output, or Tier 1 throughput.
...
| AArch64 SIMD correctness | Partially proven for F32 matvec on local NEON host | `documentation/dev-notes/2026-06-27-tier1-aarch64-neon-f32-matvec.md`; `cargo test -p ferrite-inference f32_matvec_uses_neon_backend_on_aarch64 -- --nocapture` |
| AVX2 correctness | Not proven | No x86_64 AVX2 kernel or x86 host evidence yet |
| Quantized SIMD correctness | Not proven | Q4_K, Q5_0, Q6_K, and Q8_0 kernels are still scalar/direct paths |
...
Commands run after the aarch64 NEON F32 matvec slice:
...
- Add x86_64 AVX2 F32 matvec behind ADR 0006's unsafe-boundary rules.
- Add reference-checked SIMD paths for quantized matvec kernels, starting with
  Q8_0 or Q4_K.
