...
`llama.cpp` deterministic reference profiles for the same four prompts, and
those Q8_0/Q6_K prompt profiles now also match on x86_64 AVX2. SmolLM2-1.7B,
Qwen2.5-0.5B, and Qwen2.5-1.5B Q4_K_M also matched their first three fixed
prompts on x86_64 AVX2. The Qwen2.5-1.5B proof exercises the Tier 1
head_dim=128 model.
...
- Expand Qwen2 coverage beyond the four fixed Q4_K_M prompt profiles and the
  Qwen2.5-0.5B Q8_0/Q6_K prompt profiles. Broader prompt coverage, 1.5B
