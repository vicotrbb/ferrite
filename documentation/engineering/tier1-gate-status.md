...
endpoint shapes and six-prompt legacy-completion coverage. The
...
legacy-completion proofs plus Q8_0 six-prompt chat proof while preserving the
single-inference-permit runtime invariant.
