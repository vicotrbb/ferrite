...
current benchmark-token profile measures 82,289,555 ns, about 12.15 tok/s. The
full Tier 1 throughput gate remains open because broader models, quantizations,
prompts, x86_64 throughput, memory posture, and HTTP throughput are not yet
proven.
...
throughput,
concurrent real-model successful serving, or broader Tier 1 server behavior. A
separate opt-in proof now verifies real Tier 1 backpressure:
