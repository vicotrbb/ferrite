...
Qwen2.5-1.5B Q6_K now has the first larger-artifact x86_64 generated-context
slice at the 256-token budget, proving the same generated follow-up context,
token-limit status, request-error recovery, disconnect/reconnect recovery,
per-token latency summaries, RSS sampling, and integrated completion on an
amd64 AVX2 pod. The 512/1024-token Q6_K lengths, Qwen2.5-1.5B Q8_0,
