...
one-token CLI probes, but the full Tier 1 throughput gate remains open because
broader models, quantizations, prompts, x86_64 throughput, full-tier memory
posture, and HTTP throughput are not yet proven.
...
| Tier 1 memory posture | Bounded locally for one-token Qwen2.5-1.5B Q8_0 and Q6_K CLI probes; full-tier memory posture remains unproven | `documentation/benchmarks/2026-06-28-tier1-qwen2-1-5b-q8-q6-memory.md`; Qwen2.5-1.5B Q8_0 reported `model_file_bytes=1894532128`, `scalar_weight_bytes=1888581632`, `kv_cache_bytes=172032`, max RSS 3,821,076,480 bytes, and peak footprint 3,822,526,784 bytes; Qwen2.5-1.5B Q6_K reported `model_file_bytes=1464178720`, `scalar_weight_bytes=1458228224`, `kv_cache_bytes=172032`, max RSS 2,961,850,368 bytes, and peak footprint 2,962,856,576 bytes; both runs reported `model_file_retained_bytes=0` and matched expected generated token ID `198` |
...
- Expand memory evidence beyond the bounded local one-token Qwen2.5-1.5B
  Q8_0/Q6_K CLI probes. Full-tier memory posture, long-context KV-cache growth,
  server memory behavior, and steady-state RSS remain unproven.
