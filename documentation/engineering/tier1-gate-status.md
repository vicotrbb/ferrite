...
Qwen2.5-0.5B Q4_K_M also has a bounded x86_64 AVX2 staging run for the same
explicit-stop long-chat shape, proving `finish_reason=stop`, one emitted
streaming token event, usage accounting, timing summaries, RSS samples,
