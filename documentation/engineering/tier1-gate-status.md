...
- Expand memory evidence beyond the bounded local one-token Qwen2.5-1.5B
  ...
  probes, and Qwen2.5-1.5B Q8_0/Q6_K sequential and three-request queue server
  RSS probes. Full-tier memory posture, large-context KV-cache growth, broader
  concurrent server memory behavior, and longer-running
