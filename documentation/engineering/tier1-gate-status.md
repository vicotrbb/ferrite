...
Qwen2.5-0.5B Q4_K_M overlap proof and real Qwen2.5-1.5B Q8_0 overlap and
three-request queue-order proofs while preserving the single-inference-permit
runtime invariant.
...
- Expand real Tier 1 HTTP server coverage beyond deterministic one-token
  ...
  Qwen2.5-0.5B Q4_K_M overlap proof plus real Qwen2.5-1.5B Q8_0 overlap and
  three-request queue-order probes, but server throughput, broader successful
