...
| OpenAI-compatible combined reconnect/error long-chat proof | Proven locally for Qwen2.5-0.5B Q4_K_M and Qwen2.5-1.5B Q8_0 at 256, 512, and 1024 completion tokens. Each run used `--probe-max-tokens`, so the request-error reconnect path, disconnect reconnect path, and four repeated streaming chat scenarios used the same token budget for each run. Qwen2.5-1.5B Q6_K, SmolLM2-1.7B Q4_K_M, x86_64, longer steady-state behavior, and memory-focused reruns remain unproven | `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-1024.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-1024.md`; both Qwen2.5-0.5B Q4_K_M and Qwen2.5-1.5B Q8_0 completed 256/512/1024 runs with matching probe token budgets, four `finish_reason=length` scenarios each, stable usage accounting, streaming timing, and `long_chat_summary_run_complete=true`; all combined runs reported `401` error recovery, disconnect/reconnect completion, and `[DONE]`-terminated streaming responses; the Qwen2.5-1.5B Q8_0 256-token RSS samples include anomalously low values and are not memory-posture proof |
