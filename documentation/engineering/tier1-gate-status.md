...
| OpenAI-compatible generated-context long-chat proof | Partially proven locally for Qwen2.5-0.5B Q4_K_M at 256, 512, and 1024 completion tokens, and for Qwen2.5-1.5B Q8_0 at 256 completion tokens. These current-harness reruns prove the first turn used seed assistant context, follow-up turns used generated assistant context, token-limit status was present, reconnect after disconnect started a fresh generated stream, and each integrated run completed. Qwen2.5-1.5B Q8_0 still needs 512/1024-token generated-context reruns; Qwen2.5-1.5B Q6_K, SmolLM2-1.7B, x86_64 generated-context reruns, EOS-specific long-chat behavior, and steady-state serving remain unproven | `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-generated-context-probe-1024.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-generated-context-probe-256.md`; the Qwen2.5-0.5B release runs at 256, 512, and 1024 tokens and the Qwen2.5-1.5B Q8_0 256-token release run on commit `20c9b8afbc8bba63a669f60f41101896d24a053b` all wrote exit code `0`; all runs reported turn 1 as `long_chat_result_assistant_context_source=seed`, turns 2-4 as `generated`, and summaries with `long_chat_summary_all_follow_up_turns_use_generated_context=true`, `long_chat_summary_all_token_limit_status_present=true`, `long_chat_summary_disconnect_probe_reconnect_started_new_generation=true`, and `long_chat_summary_run_complete=true` |
