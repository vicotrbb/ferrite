...
- Treat the Q4_K/Q6_K x Q8_K path as an approved experimental parity-scoped
  ...
  role subset, and the first single-role probes leave only `ffn_up` as a narrow
  candidate needing broader parity and repeated benchmark evidence.
