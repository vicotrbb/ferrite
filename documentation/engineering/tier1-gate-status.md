...
and streaming legacy completion regressions plus a one-prompt chat and
streaming chat regression. This proves the local server path can drive real
Tier 1 GGUF models for deterministic one-token responses, and bounded local
latency
