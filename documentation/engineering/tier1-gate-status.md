...
| OpenAI-compatible combined reconnect/error long-chat proof | Proven locally for Qwen2.5-0.5B Q4_K_M, Qwen2.5-1.5B Q8_0, and Qwen2.5-1.5B Q6_K at 256, 512, and 1024 completion tokens. Each run used `--probe-max-tokens`, so the request-error reconnect path, disconnect reconnect path, and four repeated streaming chat scenarios used the same token budget for each run. SmolLM2-1.7B Q4_K_M, x86_64, longer steady-state behavior, and memory-focused reruns remain unproven | `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-0-5b-probe-1024.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q8-probe-1024.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q6-probe-256.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q6-probe-512.md`; `documentation/benchmarks/2026-07-01-openai-long-chat-qwen-1-5b-q6-probe-1024.md`; Qwen2.5-0.5B Q4_K_M, Qwen2.5-1.5B Q8_0, and Qwen2.5-1.5B Q6_K completed 256/512/1024 runs; each recorded matching probe token budgets, four `finish_reason=length` scenarios, stable usage accounting, streaming timing, and `long_chat_summary_run_complete=true`; all combined runs reported `401` error recovery, disconnect/reconnect completion, and `[DONE]`-terminated streaming responses; the Qwen2.5-1.5B Q8_0 256-token RSS samples include anomalously low values and are not memory-posture proof |
