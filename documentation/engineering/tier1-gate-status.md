...
request-rate samples for Q4_K_M 0.5B and Q8_0/Q6_K 1.5B. Qwen2.5-0.5B Q4_K_M
...
This is narrow chat evidence only; additional chat models, longer generations,
x86_64, and steady-state behavior remain open.
