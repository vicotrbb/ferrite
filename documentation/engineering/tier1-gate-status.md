...
the 256-token and 512-token budgets when using the known full-length
operational prompt shape from the earlier SmolLM2 full matrix.
...
steady-state behavior, and combined reconnect/error runs for the larger
required Tier 1 artifacts remain unproven.
