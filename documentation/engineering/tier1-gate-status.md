...
- Use `--profile-next-token` or `--profile-benchmark-token` to isolate hot
  ...
  and x86_64 Qwen2.5-1.5B Q6_K now points most strongly at the final Q6_K
  output projection.
