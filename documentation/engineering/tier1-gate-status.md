...
three-request queue-order, and Q8_0/Q6_K six-prompt legacy-completion proofs
...
- Expand real Tier 1 HTTP server coverage beyond deterministic one-token
  ...
  three-request queue-order probes, and Q8_0/Q6_K six-prompt
