...
matvec reference-comparison gate, and aarch64 NEON F32 and Q8_0 matvec paths
checked against the scalar oracle. It does not yet prove AVX2 correctness,
Q4_K/Q5_0/Q6_K SIMD kernels, real 0.5B-1.7B model output, or Tier 1
throughput.
...
| AArch64 SIMD correctness | Partially proven for F32 and Q8_0 matvec on local NEON host | `documentation/dev-notes/2026-06-27-tier1-aarch64-neon-f32-matvec.md`; `documentation/dev-notes/2026-06-27-tier1-aarch64-neon-q8-matvec.md`; targeted aarch64 backend tests |
| AVX2 correctness | Not proven | No x86_64 AVX2 kernel or x86 host evidence yet |
| Quantized SIMD correctness | Partially proven for Q8_0 on local NEON host | `documentation/dev-notes/2026-06-27-tier1-aarch64-neon-q8-matvec.md`; Q4_K, Q5_0, and Q6_K kernels are still scalar/direct paths |
...
Commands run after the aarch64 NEON Q8_0 matvec slice:
...
- Add reference-checked SIMD paths for the remaining quantized matvec kernels,
  starting with Q4_K, Q5_0, or Q6_K.
