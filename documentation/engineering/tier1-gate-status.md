...
local Qwen2.5-1.5B Q8_0 OpenAI-compatible server path also has bounded
post-load and sequential one-token request RSS samples. The full Tier 1
...
| Tier 1 memory posture | Bounded locally for one-token Qwen2.5-1.5B Q8_0 and Q6_K CLI probes with peak RSS and post-load current RSS samples; bounded locally for Qwen2.5-1.5B Q8_0 OpenAI-compatible server post-load RSS and three sequential one-token endpoint cycles; full-tier memory posture remains unproven | `documentation/benchmarks/2026-06-28-tier1-qwen2-1-5b-q8-q6-memory.md`; `documentation/benchmarks/2026-06-28-tier1-qwen2-1-5b-q8-server-memory.md`; `documentation/dev-notes/2026-06-28-cli-load-memory-sampling-pause.md`; Qwen2.5-1.5B Q8_0 reported `model_file_bytes=1894532128`, `scalar_weight_bytes=1888581632`, `kv_cache_bytes=172032`, max RSS 3,821,076,480 bytes, peak footprint 3,822,526,784 bytes, and post-load CLI current RSS 1,926,742,016 bytes; Qwen2.5-1.5B Q6_K reported `model_file_bytes=1464178720`, `scalar_weight_bytes=1458228224`, `kv_cache_bytes=172032`, max RSS 2,961,850,368 bytes, peak footprint 2,962,856,576 bytes, and post-load CLI current RSS 1,497,677,824 bytes; both CLI runs reported `model_file_retained_bytes=0` and matched expected generated token ID `198`; the Qwen2.5-1.5B Q8_0 server repeated pass sampled 1,928,036,352 bytes after health and 1,958,854,656 bytes after three sequential cycles covering legacy completion, chat completion, legacy completion streaming, and chat streaming with HTTP `200` responses |
...
- Expand memory evidence beyond the bounded local one-token Qwen2.5-1.5B
  Q8_0/Q6_K CLI probes and the Qwen2.5-1.5B Q8_0 sequential server RSS probe.
