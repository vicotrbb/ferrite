...
- Expand real Tier 1 HTTP server coverage beyond deterministic one-token
  ...
  Qwen2.5-0.5B Q4_K_M overlap proof and one real Qwen2.5-1.5B Q8_0 overlap
  proof, but server throughput, broader successful concurrent real-model
  serving, queue fairness, long-stream overlap, and broader model/prompt
