...
Q4_K_M matched fixed local `llama.cpp` deterministic reference profiles for
three prompts. SmolLM2-1.7B, Qwen2.5-0.5B, and Qwen2.5-1.5B also matched
their three fixed prompts on x86_64 AVX2. The Qwen2.5-1.5B proof exercises the
...
| Real 0.5B-1.7B model output | Partially proven for three fixed 1.7B Llama-family prompts and three fixed Qwen2 prompts on local aarch64 and x86_64 AVX2 | `documentation/dev-notes/2026-06-27-tier1-smollm2-1-7b-reference-probe.md`; `documentation/dev-notes/2026-06-28-tier1-smollm2-second-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-third-prompt-reference.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-rope-layout.md`; `documentation/dev-notes/2026-06-27-tier1-qwen2-1-5b-reference-probe.md`; `documentation/dev-notes/2026-06-28-tier1-qwen2-second-prompt-reference.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-0-5b-prompt-expansion.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-qwen2-1-5b-model-check.md`; `documentation/dev-notes/2026-06-28-tier1-avx2-smollm2-1-7b-model-check.md`; Ferrite matched local `llama.cpp` token IDs `[18, 198, 3725, 198, 198, 788]`, `[7042,30,2]`, and `[28,281,253,1165,6560,32047]` for SmolLM2-1.7B-Instruct Q4_K_M; both Qwen2.5 Q4_K_M models matched `[198,9707,11]` for `hello world`, their documented France continuations, and `[11,1052,572]` for `Once upon a time`; SmolLM2-1.7B, Qwen2.5-0.5B, and Qwen2.5-1.5B Q4_K_M also matched those fixed prompts on x86_64 AVX2 |
...
- Expand real model-output coverage beyond the fixed three-prompt profiles and
