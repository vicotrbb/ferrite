...
request-rate samples for legacy completion SSE and chat SSE on Q4_K_M 0.5B and
Q8_0 1.5B. Qwen2.5-0.5B Q4_K_M legacy streaming completed 10 sequential
...
requests in 7,348 ms for about 1.22 req/s. This is narrow streaming evidence
only; additional streaming models, longer generations, x86_64, and
steady-state behavior remain open.
